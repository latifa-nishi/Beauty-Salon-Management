...
<body>
    ...
    <div class="container">
        <h1>Welcome to Beauty Parlor Management, Staff</h1>
        <div class="options">
            <a href="s_staff.php" class="option">Staff</a>
            <a href="s_staff_schedule.php" class="option">Staff Schedule</a>
            <a href="s_services.php" class="option">Services</a>
            <a href="s_spop.php" class="option">Staff FanBase</a>
            <a href="s_review.php" class="option">Review</a>
        </div>
    </div>
</body>
</html>
